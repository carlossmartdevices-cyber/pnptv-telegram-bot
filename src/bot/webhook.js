 ...
 * Optimized for VPS deployment with health checks and graceful shutdown
 */
...
app.get("/pay", async (req, res) => {
  try {
    ...
    // Serve the Daimo payment page
    const paymentPagePath = path.join(__dirname, "../../public/pay.html");
